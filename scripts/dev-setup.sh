...
echo "============================================"
echo ""
echo "To start all servers:           pnpm start"
echo "  (or individually)"
echo "  API server:                   pnpm dev"
echo "  Frontend v1 (React):          cd workflowbuilder && pnpm --filter @workflow-builder/frontend dev"
echo "  Frontend v2 (Vue):            cd workflowbuilder && pnpm --filter @r360/frontend-v2 dev"
echo ""
...
echo ""
echo "Seed workflows:"
echo "  Hello World Workflow          — ready to execute"
echo "  POR Demo AI Automation        — requires Airtop + OpenAI credentials (configure via API)"
echo ""
